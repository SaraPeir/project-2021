...
module.exports = {
  ...
  output: { 
    ...
    // contenthash just to change the hash of the files which actually changed and their parents
    filename: "[name].[contenthash].js"
  },

  // devtool: 'source-map because only a comment is generated into the JS bundle. If your users do not open the browser’s devtools, they do not load the corresponding source map file generated by webpack.
  devtool: 'source-map',
  watch: true,
  plugins: [htmlPlugin, loaderOptionPlugin, new miniCssExtractPlugin({filename: "styles/[name].[contenthash].css"}), new BundleAnalyzerPlugin()],
  devServer: {
    port: 3000,
  ...
  optimization: {
    moduleIds: 'named',
    // separated bundle for manifest, to optimize caching in case of code updating
    runtimeChunk: {
       name: "manifest",
    }, 
    splitChunks: {
